...
Run 2026-09-19T21:59:13.803Z by `app/e2e/run.mjs` against the real server and MongoDB, headless local Chrome. Screenshots: `evidence/screenshots/app/`.
...
| L2 | '/' is the landing page whatever state the workspace is in, and it links on to Setup | ✅ pass |  |
